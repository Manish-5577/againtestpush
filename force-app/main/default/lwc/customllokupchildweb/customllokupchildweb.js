...
export default class Customllokupchildweb extends LightningElement {
   ...
   // initial function to populate default selected lookup record if defaultRecordId provided  
    ...
    @wire(searchLookupData, { searchKey: '$searchKey' , sObjectApiName : '$sObjectApiName' })
     searchResult(value) {
        console.log('what is coming from value'+value);
        console.log(value);
  ...
  // update searchKey property on input field change  
    handleKeyChange(event) {
        ...
        console.log('what is ther in search key'+this.searchKey);
        }, 300);
    }
